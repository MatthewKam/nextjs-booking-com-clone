...
const products = [
	...
	{
		name: "Book a Flight",
		description: "Speak direclty to your customers",
		href: "#",
		...
		<header className="bg-[#013B94]">
			<nav
				...
				<Popover.Group className="hidden lg:flex lg:gap-x-12">
					<Popover className="relative">
						<Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-white">
							...
							<ChevronDownIcon
								...
								aria-hidden="true"></ChevronDownIcon>
						</Popover.Button>
						<Transition
							as={Fragment}
							...
							leaveTo="opacity-0 tranlste-y-1">
					...
					<a href="#" className="text-sm font-semi-bold leading-6 text-white">
						Flights
					</a>
					<a href="#" className="text-sm font-semi-bold leading-6 text-white">
						Car Rentals
